...
<br><br>
<center><img src="pics/customBuf.png" width="600"><br>Figure 1. Custom buffer table generated by user-specified disturbance industries and types.</center>
<br><br>     
  ...
  2. **Use overall buffers:** Select this option if a single buffer width is to be applied to linear and areal disturbances. Different buffer widths can be applied to the linear and areal disturbances.
     ...
     If selected, use the sliders to set buffers. The slider options provide increments of 50 m. If the slider options are not sufficient, use the custom buffers option above. 
